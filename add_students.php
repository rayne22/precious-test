...
if(isset($_POST['submit']))
{
	...
	$sql = "INSERT INTO `users` (email,password,roles) VALUES ('$email','$hashpass','student')";
	mysqli_query($con, $sql);
	$sql2 = "INSERT INTO `students` (email,f_id,f_name,l_name) VALUES ('$email','$f_id','$f_name','$l_name')";
