...
if(isset($_POST['submit']))
{
	...
	$sql = "INSERT INTO `users` (email,password,roles) VALUES ('$email','$hashpass','marketing_manager')";
	mysqli_query($con, $sql);
	$sql2 = "INSERT INTO `marketing_manager` (mm_email,f_name,l_name) VALUES ('$email','$f_name','$l_name')";
...
<body>
	...
	<form action="add_manager.php" method="POST">
		...
		<div class="form-group">
	    	...
	    	<input type="email" class="adding" id="email" onBlur="userAvailability()" name="email" required >
